...
export const MCP_PRESETS: Record<string, McpServerPreset> = {
  ...
  filesystem: {
    label: "Filesystem",
    description: "Read and write files on your local filesystem with configurable access paths",
    command: "npx",
    args: ["-y", "@modelcontextprotocol/server-filesystem", process.env.HOME || process.env.USERPROFILE || "."],
    npmPackage: "@modelcontextprotocol/server-filesystem",
    setupNotes: "Edit the args to specify which directories to allow access to.",
  },
  github: {
    label: "GitHub",
    ...
    setupNotes: "Set GITHUB_PERSONAL_ACCESS_TOKEN env variable with a GitHub personal access token.",
  },
  "brave-search": {
    label: "Brave Search",
    ...
    setupNotes: "Set BRAVE_API_KEY env variable. Get a free API key at brave.com/search/api.",
  },
  memory: {
    label: "Memory",
    description: "Persistent knowledge graph memory — stores and recalls facts across sessions",
    command: "npx",
  ...
  fetch: {
    label: "Fetch",
    description: "Make HTTP requests and fetch web content from any URL",
    command: "npx",
  ...
  postgres: {
    ...
    setupNotes: "Edit the args to provide your PostgreSQL connection string.",
  },
  slack: {
    label: "Slack",
    description: "Read and send Slack messages, search channels and users",
    command: "npx",
    args: ["-y", "@modelcontextprotocol/server-slack"],
    npmPackage: "@modelcontextprotocol/server-slack",
    setupNotes: "Set SLACK_BOT_TOKEN and SLACK_TEAM_ID env variables. Create a Slack app at api.slack.com.",
  },
};
